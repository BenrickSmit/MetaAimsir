 ...
 * @brief: displays the required buttons for the user to interact with
 */
...
Item {
    ...
    AboutViewMenuBar{
        ...
        function_description: "master_view"
    }//end of AboutViewMenuBar

    //Display the list of options
    ListView {
        id: about_view_main_view_list_view
