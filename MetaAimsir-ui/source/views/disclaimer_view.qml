 ...
 * @brief: displays the data disclaimer found on openweathermap.org which also applies to this program
 */
...
Item {
    ...
    Text {
        ...
        font.pixelSize: Styles.default_disclaimer_text_size
        text: Styles.default_disclaimer_text
