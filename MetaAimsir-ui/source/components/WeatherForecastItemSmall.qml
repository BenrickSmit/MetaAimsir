 ...
 * @brief: displays the necessary forecast information in a small enough capacity to line them up in a row for a few days
 */
...
Item {
    id: weather_forecast_item_small_item_frame

    width: _min_width//(parent.width > _min_width) ? parent.width : _min_width
    height: parent.height//(parent.height > _min_height) ? parent.height: _min_height
    ...
    property string weather_day: "mon"
    ...
    property real _min_height: 180
    property real _min_width: 120
    ...
    //Add in the day
    Text {
        id: weather_forecast_item_day_text
        text: weather_day

        anchors.centerIn: parent
        anchors.verticalCenterOffset: -(parent.height/2) + (weather_forecast_item_day_text.height/1.4)
    ...
    Item{
        ...
        Item {
            ...
            Text{
                ...
                font.pixelSize: 22//Styles.default_text_header_pixel_size
                color: Styles.default_text_colour
            }//end of Text
            ...
            Text{
                ...
                font.pixelSize: 14//Styles.default_text_small_header_pixel_size
                color: Styles.default_text_colour
            }//end of Text
            ...
            Text{
                ...
                anchors.centerIn: parent
                font.pixelSize: 14//Styles.default_text_pixel_size
                font.capitalization: Font.Capitalize
                color: Styles.default_text_colour
            }//end of text
        }//end of Item
